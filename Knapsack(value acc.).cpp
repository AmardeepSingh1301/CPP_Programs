...
void sortvl() // function to sort according value decreasing order.
{
    for (int i = 0; i < n; i++)
    {
    ...
    cout << "Items after sorting as per max. value" << endl;
    for (int i = 0; i < n; i++)
    {
...
void calc(int mvl,char fset[][50]) // function to calculate the sack wt.
{
    int t = n;
    int i = 0;
